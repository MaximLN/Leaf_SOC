...
//        private String mSocketType;
        private String mSocketType = "SPP";
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                Log.d(TAG, "AcceptThread() Run cicle While");
                try {
                    // This is a blocking call and will only return on a
                    // successful connection or an exception
                    socket = mmServerSocket.accept();
                    Log.e(TAG, "AcceptThread() Run cicle While /// socket = mmServerSocket.accept()");
                } catch (IOException e) {
                ...
                if (socket != null) {
                    synchronized (BluetoothService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
                            Log.d(TAG, "AcceptThread() Run cicle While STATE_LISTEN");
                        case STATE_CONNECTING:
                            // Situation normal. Start the connected thread.
                            Log.d(TAG, "AcceptThread() Run cicle While STATE_CONNECTING");
                            connected(socket, socket.getRemoteDevice(), mSocketType);
                            break;
                        case STATE_NONE:
                            Log.d(TAG, "AcceptThread() Run cicle While STATE_NONE");
                        case STATE_CONNECTED:
                            Log.d(TAG, "AcceptThread() Run cicle While STATE_CONNECTED");
                            // Either not ready or already connected. Terminate new socket.
                            try {
                                socket.close();
                                Log.d(TAG, "AcceptThread() Run cicle While socket.close()");
                            } catch (IOException e) {
